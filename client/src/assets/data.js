...
export const tasks = [
  {
    _id: "65c4586f0548279012f8c256",
    title: "Bug Fixing",
    notes: "Fix critical login issues and UI rendering bugs in the dashboard",
    date: "2024-02-07T00:00:00.000Z",
    priority: "high", // Keep original priority value
    priorityStars: "⭐⭐⭐", // 3 Stars representation for high priority
    stage: "todo",
    remindOnDate: "2024-02-09T00:00:00.000Z",
    remindOnTime: "09:00:00",
    atLocation: "Office - Main Building",
    meetingPerson: "David Tech Lead",
    earlyReminder: true,
    repeat: "weekly",
    flagged: true,
    assets: [
    ...
    attachment: [
      { name: "bug-report.pdf", url: "https://example.com/bug-report.pdf" },
      {
        name: "login-flowchart.png",
        url: "https://example.com/login-flowchart.png",
      },
    ],
    team: [
      {
  ...
  },
  {
    ...
    notes: "Create a project proposal for the new corporate website redesign",
    date: "2024-02-07T17:55:13.218Z",
    priority: "high", // Keep original priority value
    priorityStars: "⭐⭐⭐", // 3 Stars representation for high priority
    stage: "todo",
    remindOnDate: "2024-02-10T00:00:00.000Z",
    remindOnTime: "14:30:00",
    atLocation: "Conference Room B",
    meetingPerson: "Marketing Director",
    earlyReminder: true,
    repeat: "none",
    flagged: true,
    assets: [],
    attachment: [
      {
        name: "previous-proposal.docx",
        url: "https://example.com/previous-proposal.docx",
      },
    ],
    team: [
      {
